    ...
    <div  class="option" v-if="authen.id == item.id_user">
        <div class="option__menu" @click="showmenuoption(item.id , type)">
            <div  class="option__menu--list" :id="'option_' + type + item.id">
                ...
                <div class="menu__item" v-if="checkinclupin(item.id, type) == true" @click="pin_mess(item, type)">
                ...
                <div class="menu__item" @click="checkunghim(item.id)" v-if="checkinclupin(item.id, type) == false && check_head(item.id, type) == true">
...
export default {
    ...
    setup() {
        const { authen, room, checkunghim,check_head, showmenufeel,reply,showmenuoption,check_move,checkinclupin,array_pin_room,pin_mess,outfeel,post_feel,icon,array_icon,deletefeel } = data();
        return {authen,room, checkunghim,check_head, showmenufeel,reply,showmenuoption,check_move,checkinclupin,array_pin_room,pin_mess,outfeel,post_feel,icon,array_icon,deletefeel };
    },
    created() {
